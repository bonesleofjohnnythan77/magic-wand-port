...
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ -5055, 1714, -2569),
	TRAJECTORY_POS(1, /*pos*/ -5381, 3315, 3160),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702ECC0_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 884, 0, -15321),
	TRAJECTORY_POS(1, /*pos*/ 884, 0, 21434),
	TRAJECTORY_END(),
};
...
const Trajectory bob_seg7_metal_ball_path1[] = {
    TRAJECTORY_POS(0, /*pos*/   -3625,  281, -2855),
    TRAJECTORY_POS(1, /*pos*/   -4277,  156, -2070),
    TRAJECTORY_POS(2, /*pos*/   -4757,  62, -1955),
    TRAJECTORY_POS(3, /*pos*/   -5317,  31, -2056),
    TRAJECTORY_POS(4, /*pos*/   -5960,  -101, -2795),
    TRAJECTORY_POS(5, /*pos*/   -6498,  -291, -4669),
    TRAJECTORY_POS(6, /*pos*/   -5256,  -381, -6094),
    TRAJECTORY_POS(7, /*pos*/   -3668,  -616, -5765),
    TRAJECTORY_POS(8, /*pos*/   -2618,  -947, -3912),
    TRAJECTORY_POS(9, /*pos*/   -2364,  -947, -1768),
    TRAJECTORY_POS(10, /*pos*/   -2586,  -947, 238),
    TRAJECTORY_END(),
};
...
// LOAD_MODEL_FROM_GEO(54,0x0e000390),
// LOAD_MODEL_FROM_GEO(55,0x0e000360),
// LOAD_MODEL_FROM_GEO(56,0x0e000378),
...
AREA(1,Geo_sl_1_0x40ebe8),
TERRAIN(col_sl_1_0x700cbd8),
SET_BACKGROUND_MUSIC(0,8),
TERRAIN_TYPE(2),
JUMP_LINK(local_objects_sl_1_),
JUMP_LINK(local_warps_sl_1_),
MACRO_OBJECTS('local_macro_objects_sl_1_')END_AREA(),
RETURN()
};
...
const MacroObject local_macro_objects_sl_1_[] = {
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,90,4086,1024,400,86),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_horizontal,64,64876,2120,1340,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,292,64701,1125,61680,61),
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,180,60486,1020,6026,16),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fly_guy,0,2766,1522,61903,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,135,61936,1024,64736,148),
...
AREA(2,Geo_sl_2_0x40ecc4),
TERRAIN(col_sl_2_0x700effc),
SET_BACKGROUND_MUSIC(0,12),
TERRAIN_TYPE(2),
JUMP_LINK(local_objects_sl_2_),
JUMP_LINK(local_warps_sl_2_),
MACRO_OBJECTS('local_macro_objects_sl_2_')END_AREA(),
RETURN()
};
...
WARP_NODE(240,6,2,54,0),
WARP_NODE(241,6,2,104,0),
const MacroObject local_macro_objects_sl_2_[] = {
